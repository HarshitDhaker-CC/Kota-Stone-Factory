...
(function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', async function(e) {
      ...
      const data = {
        ...
        phone:   this.querySelector('[name="phone"]') ? this.querySelector('[name="phone"]').value.trim() : '',
        enquiry: this.querySelector('[name="enquiry"]') ? this.querySelector('[name="enquiry"]').value : '',
  ...
  function handleNewsletter(input, btn, form) {
    ...
    .then(json => {
      ...
      showToast(form, json.message || '✓ You\'re subscribed! Thank you.', 'success');
      setTimeout(() => {
    ...
    .catch(() => {
      btn.disabled = false;
      btn.innerHTML = origHtml;
      showToast(form, 'Could not connect. Please try again.', 'error');
    });
  }
